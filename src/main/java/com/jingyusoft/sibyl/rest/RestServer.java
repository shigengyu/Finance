 ...
 ******************************************************************************/
package com.jingyusoft.sibyl.rest;
...
public class RestServer implements BeanPostProcessor {
	...
	public static void main(final String args[]) throws Exception {
		...
		applicationContext = new ClassPathXmlApplicationContext(
				"classpath:com/jingyusoft/sibyl/config/application-context-rest.xml");

		if (applicationContext.isActive()) {
			LOGGER.info("application-context-rest.xml loaded");
		}
	...
	@Value("${sibyl.rest.server.host}")
	private String restServerHost;

	@Value("${sibyl.rest.server.port}")
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		if (bean.getClass().isAnnotationPresent(SibylController.class)) {
